...
import 'package:kebudayaan/berita/detailBerita.dart';
import 'package:kebudayaan/model/modelBerita.dart';
import 'package:kebudayaan/sessionManager.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                alignment: Alignment.topLeft,
                child: Text(
                  "Welcome to Minangkabau Culture!",
              ...
              Stack(
                children: [
                  Center(
                    child: Image.asset("images/icon.png",width: 250, height: 250,)
                  ),
                  Positioned(
                    left: 0,
                    right: 0,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            '${ApiUrl().baseUrl}${dataItem?.gambarBerita}',
                                            width: 150,
                                            height: 100,
                                            fit: BoxFit.fill,
                                          ),
